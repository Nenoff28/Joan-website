# Selected Subcategory Layout Validation
...
The redundant **„Подбрани продукти / Продукти в … / Продуктите са филтрирани …“** listing heading has also been removed for selected subcategory paths. Desktop now proceeds from the hero to the result count and sorting control; mobile proceeds from the hero to the filter control, sorting, and product cards. The mobile filter action remains available.
