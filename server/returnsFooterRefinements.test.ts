...
describe("returns FAQ and footer refinements", () => {
  ...
  it("groups the supplied accessible Facebook link and map destination with the left contact details", () => {
    ...
    expect(storefrontSource).toContain('src="/manus-storage/joan-facebook-replacement-transparent_febf96d7.png"');
    expect(storefrontSource).toContain('src="/manus-storage/joan-instagram-bright-transparent_f9fbc4ee.png"');
