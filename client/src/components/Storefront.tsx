    ...
    <footer className="site-footer">
      <div className="page-frame footer-main">
        <div className="footer-brand">
          ...
          <div className="footer-social-row" aria-label="Социални мрежи"><a className="footer-facebook" href="https://www.facebook.com/www.joan.bg" target="_blank" rel="noreferrer" aria-label="Facebook на ЖОАН" title="Facebook на ЖОАН"><img src="/manus-storage/joan-facebook-replacement-transparent_febf96d7.png" alt="" /></a><span className="footer-social-placeholder" role="img" aria-label="Instagram на ЖОАН — профилът предстои" title="Instagram — скоро"><img src="/manus-storage/joan-instagram-bright-transparent_f9fbc4ee.png" alt="" /></span><span className="footer-social-placeholder" role="img" aria-label="TikTok на ЖОАН — профилът предстои" title="TikTok — скоро"><img src="/manus-storage/joan-tiktok-replacement-transparent_e8932721.png" alt="" /></span></div>
        </div>
